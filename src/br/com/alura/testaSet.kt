...
fun testaSet() {
    val assistiramCursoAndroid: Set<String> = setOf(
        "Alex",
        "Alejandro",
        "Alejandro",
        "Alejand"
    ) // lista de aluno que assistiram curso Android -->> o set add elementos unicos
    val assistiramCursoKotlin: Set<String> =
        setOf("Thiago", "Pedro", "Pedro", "Plinio") // lista de aluno que assistiram curso Kotlin
