...
//  println(it) //it imprime o valor de message
    ...
    ) //retorna o valor da key 1 caso exista, caso não exista retorna o valor default -1.0 que não corresponde a um valor de pedido
    println(
        pedidos.getOrDefault(
            0,
            -1
        )
    ) //retorna -1.0 que não corresponde a um valor valido, pois a key 0 não existe, porem poderiamos retornar 0.0 por exemplo
